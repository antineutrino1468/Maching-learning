...
from Evolo.util.evaluator import MapEvaluator, SequentialEvaluator
...
class MockedProblem(FloatProblem):
    def __init__(self, number_of_variables: int = 3):
        ...
        self.variable_lb = [-5.0 for _ in range(number_of_variables)]
        self.variable_ub = [5.0 for _ in range(number_of_variables)]
