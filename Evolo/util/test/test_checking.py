import unittest
from Evolo.util.checking import (
    Check,
...
class CheckingTestCases(unittest.TestCase):
    ...
    def test_should_is_value_in_range_raise_an_exception_if_the_value_is_lower_than_the_variable_lb(self) -> None:
        with self.assertRaises(ValueOutOfRangeException):
            Check.value_is_in_range(2, 3, 5)

    def test_should_is_value_in_range_raise_an_exception_if_the_value_is_higher_than_the_variable_ub(self) -> None:
        with self.assertRaises(ValueOutOfRangeException):
