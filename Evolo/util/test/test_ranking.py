...
from Evolo.util.ranking import FastNonDominatedRanking, Ranking, StrengthRanking
...
class FastNonDominatedRankingTestCases(unittest.TestCase):
    ...
    def test_should_compute_ranking_return_a_sub_front_if_the_solution_list_contains_one_solution(self):
        solution = Solution(2, 3)
        solution_list = [solution]
        ranking = self.ranking.compute_ranking(solution_list)
        self.assertEqual(1, self.ranking.get_number_of_sub_fronts())
        self.assertEqual(solution, ranking[0][0])

    def test_should_compute_ranking_return_a_sub_front_if_the_solution_list_contains_two_nondominated_solutions(self):
        ...
        ranking = self.ranking.compute_ranking(solution_list)
        self.assertEqual(1, self.ranking.get_number_of_sub_fronts())
        self.assertEqual(2, len(self.ranking.get_sub_front(0)))
        self.assertEqual(solution, ranking[0][0])
    ...
    def test_should_compute_ranking_work_properly_case1(self):
        ...
        solution_list = [solution, solution2]
        ranking = self.ranking.compute_ranking(solution_list)
        self.assertEqual(2, self.ranking.get_number_of_sub_fronts())
        self.assertEqual(1, len(self.ranking.get_sub_front(0)))
        self.assertEqual(1, len(self.ranking.get_sub_front(1)))
        self.assertEqual(solution, ranking[0][0])
        self.assertEqual(solution2, ranking[1][0])

    def test_should_ranking_of_a_population_with_three_dominated_solutions_return_three_sub_fronts(self):
        solution = Solution(2, 2)
        solution.objectives = [2, 3]
        solution2 = Solution(2, 2)
        solution2.objectives = [3, 6]
        ...
        ranking = self.ranking.compute_ranking(solution_list)
        self.assertEqual(3, self.ranking.get_number_of_sub_fronts())
        self.assertEqual(1, len(self.ranking.get_sub_front(0)))
        self.assertEqual(1, len(self.ranking.get_sub_front(1)))
        self.assertEqual(1, len(self.ranking.get_sub_front(2)))
        self.assertEqual(solution, ranking[0][0])
        self.assertEqual(solution2, ranking[1][0])
    ...
    def test_should_ranking_of_a_population_with_five_solutions_work_properly(self):
        ...
        self.assertEqual(2, self.ranking.get_number_of_sub_fronts())
        self.assertEqual(3, len(self.ranking.get_sub_front(0)))
        self.assertEqual(2, len(self.ranking.get_sub_front(1)))
...
class StrengthRankingTestCases(unittest.TestCase):
    ...
    def test_should_ranking_work_properly(self):
        ...
        self.assertEqual(2, self.ranking.get_number_of_sub_fronts())
        self.assertTrue(solution1 in self.ranking.get_sub_front(0))
        self.assertTrue(solution2 in self.ranking.get_sub_front(0))
        self.assertTrue(solution3 in self.ranking.get_sub_front(1))
        self.assertTrue(solution4 in self.ranking.get_sub_front(0))
        self.assertTrue(solution5 in self.ranking.get_sub_front(0))
