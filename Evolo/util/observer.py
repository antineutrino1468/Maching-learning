...
from Evolo.core.problem import DynamicProblem
from Evolo.core.quality_indicator import InvertedGenerationalDistance
from Evolo.lab.visualization import Plot, StreamingPlot
from Evolo.util.solution import print_function_values_to_file

S = TypeVar("S")
LOGGER = logging.getLogger("Evolo")
"""
module:: observer
...
class VisualizerObserver(Observer):
    def __init__(self, reference_front: List[S] = None, reference_point: list = None, display_frequency: int = 1
                 ) -> None:
        self.figure = None
